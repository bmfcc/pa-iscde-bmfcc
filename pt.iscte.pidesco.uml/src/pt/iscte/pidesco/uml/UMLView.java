...
public class UMLView implements PidescoView {
	...
	private UMLServices umlServices;
	...
	public void createContents(Composite viewArea, Map<String, Image> imageMap) {
		...
		ServiceReference<UMLServices> UMLServiceReference = context.getServiceReference(UMLServices.class);
		umlServices = context.getService(UMLServiceReference);
